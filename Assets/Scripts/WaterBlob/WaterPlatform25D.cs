...
namespace WaterBlob
{
    ...
    public class WaterPlatform25D : MonoBehaviour
    {
        [Header("3D Visual Root")]
        [SerializeField] private Transform visualRoot3D;

        [Header("Gameplay Proxy")]
        [SerializeField] private WaterPlatform2D gameplayProxy2D;
        ...
        private void ResolveReferences()
        {
            ...
            gameplayProxy2D ??= GetComponentInChildren<WaterPlatform2D>();
        ...
        private void ConfigureProxy()
        {
            ...
            gameplayProxy2D?.SetExternallyDriven(true); // behave like other moving platforms
        }
    }
}